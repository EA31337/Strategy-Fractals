...
// Inputs.
INPUT_GROUP("Fractals strategy: main");
...
// Includes strategy.
#include "Stg_Fractals.mqh"

// Defines.
#define ea_name "Strategy Fractals"
#define ea_version "1.010"
#define ea_desc "Strategy based on EA31337 framework."
#define ea_link "https://github.com/EA31337/Strategy-Fractals"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_Fractals>(Active_Tfs);
